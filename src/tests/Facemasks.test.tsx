...
describe("<Facemasks> Component Tests", () => {
  fetchMock.mockResponse(
    JSON.stringify({
      rows: [
        {
          id: "ccd1da35142c4d7ece61b7",
          type: "facemasks",
          name: "AKTAIFOL FANTASY",
          color: "white",
          price: 11,
  ...
  test("Facemasks Product Card component text", () => {
    render(
      <MemoryRouter initialEntries={["/facemasks"]}>
  ...
  test("Facemasks PrintJSON component text", () => {
    render(
      <MemoryRouter initialEntries={["/api/facemasks"]}>
