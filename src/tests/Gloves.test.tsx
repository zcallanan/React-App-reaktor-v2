...
describe("<Glove> Component Tests", () => {
  fetchMock.mockResponse(
    JSON.stringify({
      rows: [
        ...
        {
          id: "da35e621ad262615e2fa9e5",
          type: "gloves",
          name: "DALLEAKOL NORMAL",
          color: "orange",
          price: 64,
          manufacturer: "hennex",
        ...
        {
          id: "1b1610b94d3d1d701b0",
          type: "gloves",
          name: "HEMFOLNY SLIP METROPOLIS",
          color: "black, blue",
          price: 54,
  ...
  test("Gloves Product Card component text", () => {
    render(
      <MemoryRouter initialEntries={["/gloves"]}>
        <Gloves slug="gloves" />
      </MemoryRouter>,
    );
